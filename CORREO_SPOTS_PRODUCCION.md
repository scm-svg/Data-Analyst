# Borrador de correo — SPOTS producción expansión

**Asunto:** SPOTS Manga Corta — Cantidades de producción aprobadas (Caracas · Valencia · Barquisimeto) + compra de tela

---

Estimados,

Comparto las **cantidades de producción sugeridas y aprobadas** para la expansión de **SPOTS Manga Corta** en las zonas **Caracas, Valencia y Barquisimeto**, con horizonte de **3 meses**.

Adjunto **`SPOTS_PRODUCCION_EXPANSION.xlsx`**, con el mismo formato usado en **Short Playa Sublimado**:
...
|------|--------|------------|
| Caracas | Diseño Caracas | **Azul Marino** |
| Valencia | Diseño Valencia | **Vinotinto** |
| Barquisimeto | Ciudad + Virgen | **Verde** (70% de Ciudad) |
...
## Indicación para Producción

Las cantidades del Excel son el **pedido objetivo** validado por análisis. **Cuando la tela esté físicamente disponible**, Producción debe **ajustar a la curva óptima de confección** (mismo criterio que Short Playa), respetando totales por color/tela aprobados y la proporción talla/género del análisis.
