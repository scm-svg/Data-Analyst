# Planificación de Producción v5.9.12 — códigos listos para pegar
...
- **Sincronizar Producción:** `Cantida Producida` en Por Hacer es la **base** y no se pisa. Cada **fila nueva al final** de `Produccion - Costura` se suma a esa celda según la MO. El histórico no se vuelve a sumar. Si una fila nueva no se aplicó, cópiala al final de Costura y vuelve a sincronizar.
